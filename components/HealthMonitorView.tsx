    ...
    <div className="flex-1 overflow-y-auto bg-slate-50 p-12">
      <div className="max-w-7xl mx-auto space-y-10">
        <header className="flex justify-between items-end">
          <div>
            <h2 className="text-4xl font-black text-slate-900 tracking-tight leading-none">Sys-Ops Monitor</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
           <div className="lg:col-span-2 space-y-8">
                      ...
                      <div key={c.id} className="flex items-center gap-6">
                         ...
                         <div className="flex-1">
                            <div className="flex justify-between items-center mb-2">
                               <span className="text-sm font-bold text-slate-800">{c.name} API Layer</span>
              ...
              <div className="bg-slate-900 rounded-[40px] p-10 text-white shadow-2xl overflow-hidden relative">
                 <div className="flex justify-between items-center mb-10">
                    <div>
                       <h3 className="text-xl font-bold">Live Inference Traffic</h3>
                       <p className="text-xs text-slate-400">Aggregated Global Requests per second</p>
                    </div>
                    <div className="text-right">
           ...
           <div className="space-y-8">
              ...
              <div className="bg-indigo-600 rounded-[40px] p-8 text-white shadow-xl">
                 ...
                 <p className="text-xs text-indigo-200 mt-2 leading-relaxed">System-wide success rate for scheduled inference jobs across all regions.</p>
                 <button className="w-full mt-8 py-3 bg-white text-indigo-600 font-black rounded-2xl text-[10px] uppercase tracking-widest shadow-lg active:scale-95 transition-all">Download SRE Report</button>
              </div>
           </div>
        </div>
      </div>
